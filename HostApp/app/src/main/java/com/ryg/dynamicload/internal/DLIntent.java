...
public class DLIntent extends Intent {
    ...
    public DLIntent setClassName(Context packageContext, String className)
    {
        super.setClassName(packageContext,className);
        this.mPluginPackage = packageContext.getPackageName();
        this.mPluginClass = className;
        return this;
    }

    public DLIntent setClassName(String packageName, String className)
    {
