...
public class DLPluginManager {
    ...
    /**该字段记录主工程的包名。
     * 如果没有调用loadApk方法，mFrom==DLConstants.FROM_INTERNAL，
     * 启动activity会当作主工程activity去启动，
     * 如果此时传进来的包名是插件包的包名，那么就会崩溃。
     * 因此在这里加上一个包名的比对，发现不是主工程包名就返回。*/
    ...
    public Bridge getBridge() {
        ...
        return this.hostBridge != null? this.hostBridge: new PluginBridge();
    }
     ...
     * @return
     */
    public boolean isHostPackageSet(){
        return hostPackageName != null && !"".equals(hostPackageName);
    }

    /**
     * 设置主工程包名
     * @param hostPackageName
     */
